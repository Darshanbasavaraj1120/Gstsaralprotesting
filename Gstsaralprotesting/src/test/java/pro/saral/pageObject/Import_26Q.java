...
public class Import_26Q extends BaseClass{
	WebDriver idriver;
	...
	int j=0;
	String fileName="TDSForm26Q_2021-22.xlsx";
	String filenamea="BLRL03775C-TDSForm24Q1.xlsx";
	
	public Import_26Q(WebDriver rdriver) throws IOException
	{
		idriver=rdriver;
	...
	@FindBy(xpath="//span[contains(text(),'Excel TDS')]//parent::div//following-sibling::div//child::button[@id='import-button']")
	@CacheLookup
	WebElement excelimportbutton;
	
	@FindBy(xpath="//span[contains(text(),'Conso File')]//parent::div//following-sibling::div//child::button")
	@CacheLookup
	WebElement consoimportbutton;
	
	@FindBy(xpath="//span[contains(text(),'Text File')]//parent::div//following-sibling::div//child::button")
	@CacheLookup
	WebElement textimportbutton;
	
	@FindBy(xpath="//span[contains(text(),'Masters Import')]//parent::div//following-sibling::div//child::button")
	@CacheLookup
	...
	@FindBy(xpath="//td[contains(text(),'CHITRA YADAV')]")
	@CacheLookup
	...
	@FindBy(xpath="//td[contains(text(),'04643')]")
	@CacheLookup
...
//		importtab.click();
	...
	public void consoimportbuttonclick() throws InterruptedException
	{
	...
	public void uploadvalidbfilepath() throws IOException
	{
		...
		String absolute = new File(readconfig.bQvalidexcel()).getCanonicalPath();
	...
	public void uploaderrorfilepath() throws IOException
	{
		...
		String absolute = new File(readconfig.berrorexcel()).getCanonicalPath();
	...
	public void uploadvalidconsofilepath() throws IOException
	{
		...
		String absolute = new File(readconfig.bvalidconso()).getCanonicalPath();
