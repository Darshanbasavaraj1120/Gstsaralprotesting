...
public class Settings extends BaseClass{
	...
	@FindBy(xpath="(//label[@class='checkbox checkbox-primary'])[3]")
	@CacheLookup
	WebElement cqcheckbox;
	
	@FindBy(xpath="(//label[@class='checkbox checkbox-primary'])[4]")
	@CacheLookup
	...
	@FindBy(xpath="//div[contains(text(),'Forms Updated Successfully')]")
	@CacheLookup
