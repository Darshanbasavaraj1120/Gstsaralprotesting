...
import pro.saral.pageObject.Import_26Q;
import pro.saral.pageObject.Employee;
import pro.saral.pageObject.LoginPage;

public class Import_26Q_Test extends BaseClass{
...
public void Login_Entry() throws InterruptedException, IOException{
	...
	@Test(priority=0)
	public void Download_Template_And_Verify_26Q() throws IOException, InterruptedException
	{
		Import_26Q imp=new Import_26Q(driver);
