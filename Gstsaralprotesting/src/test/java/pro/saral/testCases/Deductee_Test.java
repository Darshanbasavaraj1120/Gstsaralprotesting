...
public class Deductee_Test extends BaseClass {
	
	@Test(dataProvider="hybridData")
	public void Deductee_Testcases(String testcaseName,String keyword,String objectName,String objectType,String value) throws Exception {
